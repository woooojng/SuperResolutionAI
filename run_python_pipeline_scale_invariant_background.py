...
from core.python_kwave_simulation_pipeline_scale_invariant_background import UltrasoundSimulator ###
from core.python_post_processing_scale_artifact_fixed_v3 import process_batch
...
from helpers.base_options_scale_artifact_fixed_v3 import (
    SimulationConfig,
    ...
    def _create_comprehensive_config(self) -> Dict:
        ...
        return {
            ...
            * 1000,  # Convert to mm
            ...
            "system/path": os.getcwd() # it will save the path of the folder
        }
